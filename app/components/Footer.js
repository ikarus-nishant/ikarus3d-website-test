  ...
  return (
    <div className="footerparallax relative" ref={footerRef}>
      ...
      <div className="border-t-[1px] border-[#252729]">
        <ServicesSection>
          <div className="grid tab:grid-cols-2 gap-9">
            <div className="flex flex-col gap-9">
              <ServicesHeading element="h6" headings={["Join the community"]} />
              <motion.div
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ duration: 2 }}
              ...
              >
                <div className="flex flex-col lg:flex-row gap-3">
                  ...
                  <button
                    ...
                    className="flex justify-center items-center text-[16px] leading-[22px] lg:leading-[24px] shadow-xs rounded-[5px] text-center text-white px-6 py-[11px] lg:py-3 h-12 w-full lg:w-fit bg-gradient-to-r from-[#015EF1] to-[#489BE1]"
                  >
                    Subscribe
                  </button>
                </div>
      ...
      <div className="border-t-[1px] border-[#252729]">
        <ServicesSection>
          <div className="flex flex-col lg:flex-row items-start justify-between gap-2 lg:gap-[114px] mb-[50px] lg:mb-[150px]">
            <div className="flex flex-col gap-4">
              <div className="w-full">
                <img
                  src={`${env.CDN_BASE_URL}/miscellaneous/Header_Logo_D.png`}
                  alt="Ikarus3D Logo"
                  className="h-[28px] tab:h-8 md:h-[36px]"
                  loading="lazy"
                />
              </div>
              <motion.div
              ...
              >
                <div>
                  <span className="text-[#BFBFBF] font-[400] text-[16px] xl:text-[14px] leading-[21px]">{`© ${new Date().getFullYear()} Ikarus Unkindled`}</span>
                </div>
                <div className="flex flex-row gap-4">
                  <a
                    ...
                    className=""
                  >
                    <span className="text-[#BFBFBF] hover:dark:text-primaryBlue font-[400] text-[16px] xl:text-[14px] leading-[21px]">
                      Terms of Service
                    </span>
                  </a>
                  <a
            ...
            <div className="flex flex-col tab:hidden w-full">
            ...
            <div className="hidden tab:flex flex-row justify-between lg:justify-start w-full lg:w-fit gap-[100px]">
              <div className="flex flex-col gap-4">
                <motion.h6
            ...
            <div className="flex lg:hidden flex-col w-full items-center justify-center tab:items-start mt-[30px]">
              <div>
                <span className="text-[#BFBFBF] font-[400] text-[14px] leading-[21px]">{`© ${new Date().getFullYear()} Ikarus Unkindled`}</span>
              </div>
              <div className="flex flex-row gap-4">
                <a
                  href="/terms-and-conditions"
